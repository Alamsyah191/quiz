                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror"
                                        value="{{ $p->name }}" type="text" name="name"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror"
                                        value="{{ $p->email }}" type="email" name="email" placeholder="Masukan Email">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('password') is-invalid @enderror"
                                        value="{{ $p->visible_password }}" type="text" name="password"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('occupation') is-invalid @enderror"
                                        value="{{ $p->occupation }}" type="text" name="occupation" placeholder="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('address') is-invalid @enderror"
                                        value="{{ $p->address }}" type="text" name="address" placeholder="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('bio') is-invalid @enderror"
                                        value="{{ $p->bio }}" type="text" name="bio" placeholder="">
